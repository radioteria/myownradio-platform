...
class LiqPay
{
    ...
    public static $public_key = "i55247687032";
    public static $private_key = "beESp5zKYfVeiZFsy5W2AndJY9m32EsHZUMCgrqY";

    /**
     * @return LiqPay
     */
    public static function Constr() {
        return new self(self::$public_key, self::$private_key);
    }
    ...
    public function cnb_hyperlink($params) {

        $params    = $this->cnb_params($params);
        $data      = base64_encode( json_encode($params) );
        $signature = $this->cnb_signature($params);

        return sprintf("https://www.liqpay.com/api/checkout/?data=%s&signature=%s", $data, $signature);
