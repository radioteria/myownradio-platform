...
(function () {
    ...
    module.directive("hashtags", [function () {
        return {
            ...
            restrict: "E",
            template: '<span class="tags"><span class="tag" ng-repeat="tag in tags" ng-bind="tag" ng-click="tags.splice($index, 1)"></span></span><span class="current-tag" placeholder="Type new hashtag here" contenteditable="true"></span>',
            require: "?ngModel",
