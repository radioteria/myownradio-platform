...
!function (a) {
    ...
    return function a(b, c, d) {
    ...
    }, {"./add-default-options": 1, "./index": 7, "promise/polyfill.js": void 0}], 3: [function (a, b) {
        var c = a("./utils");
        ...
        b.exports = function (e, f) {
            ...
            function j(a) {
                for (var b, c = n.getElementsByTagName("style"), d = 0; d < c.length; d++)if (b = c[d], b.type.match(u)) {
                    var e = h(f);
                    e.modifyVars = a;
                    var g = b.innerHTML || "";
            ...
            function k(a, b, g, i, j) {
                function k(c) {
                    var f = c.contents, h = c.filename, j = c.webInfo, k = {currentDirectory: r.getPath(h), filename: h, rootFilename: h, relativeUrls: l.relativeUrls};
            ...
            return o.watch = function () {
                ...
                return(a || c) && c !== !1 && r.clearFileCache(), new Promise(function (c, f) {
                    ...
                    h = i = new Date, l(function (a, b, j, l, m) {
                        return a ? (s.add(a, a.href || l.href), void f(a)) : (m.local ? o.logger.info("loading " + l.href + " from cache.") : (o.logger.info("rendered " + l.href + " successfully."), b = g(b), d.createCSS(e.document, b, l), t.setCSS(l.href, m.lastModified, b)), o.logger.info("css for " + l.href + " generated in " + (new Date - i) + "ms"), 0 === m.remaining && (k = new Date - h, o.logger.info("less has finished. css generated in " + k + "ms"), c({startTime: h, endTime: i, totalMilliseconds: k, sheets: o.sheets.length})), void(i = new Date))
                    }, a, b), j(b)
                })
            }, o.refreshStyles = j, o
        }
    }, {"../less": 29, "./browser": 3, "./cache": 4, "./error-reporting": 5, "./file-manager": 6, "./log-listener": 8, "./utils": 9}], 8: [function (a, b) {
        b.exports = function (a, b) {
            var c = 4, d = 3, e = 2, f = 1;
        ...
        d.addMultiple(b)
    }, {"../tree/color": 46, "./function-registry": 21}], 17: [function (a) {
        function b(a) {
    ...
    }, {"../tree/anonymous": 42, "../tree/color": 46, "../tree/dimension": 52, "../tree/quoted": 69, "./function-registry": 21}], 18: [function (a, b) {
        b.exports = function (b) {
            var c = a("../tree/anonymous"), d = a("../tree/url"), e = a("./function-registry"), f = function (a, b) {
                return new d(b, a.index, a.currentFileInfo).eval(a.context)
            }, g = a("../logger");
            e.add("data-uri", function (a, e) {
                var h = a.value, i = e && e.value, j = b.getFileManager(i, this.context.currentFileInfo, this.context, b, !0);
                ...
                var q = p.contents, r = 32, s = parseInt(q.length / 1024, 10);
    ...
    }, {"../logger": 31, "../tree/anonymous": 42, "../tree/url": 76, "./function-registry": 21}], 19: [function (a, b) {
    ...
    }, {"../tree/keyword": 61, "./function-registry": 21}], 20: [function (a, b) {
    ...
    }, {"./function-registry": 21}], 21: [function (a, b) {
        b.exports = {_data: {}, add: function (a, b) {
    ...
    }, {"./color": 17, "./color-blending": 16, "./data-uri": 18, "./default": 19, "./function-caller": 20, "./function-registry": 21, "./math": 23, "./number": 24, "./string": 25, "./svg": 26, "./types": 27}], 23: [function (a) {
        function b(a, b, d) {
        ...
        var c = a("../tree/dimension"), d = a("./function-registry"), e = {ceil: null, floor: null, sqrt: null, abs: null, tan: "", sin: "", cos: "", atan: "rad", asin: "rad", acos: "rad"};
    ...
    }, {"../tree/dimension": 52, "./function-registry": 21}], 24: [function (a) {
        var b = a("../tree/dimension"), c = a("../tree/anonymous"), d = a("./function-registry"), e = function (a, d) {
            ...
            for (e = 0; e < d.length; e++)if (g = d[e], g instanceof b)if (h = "" === g.unit.toString() && void 0 !== l ? new b(g.value, l).unify() : g.unify(), j = "" === h.unit.toString() && void 0 !== k ? k : h.unit.toString(), k = "" !== j && void 0 === k || "" !== j && "" === m[0].unify().unit.toString() ? j : k, l = "" !== j && void 0 === l ? g.unit.toString() : l, f = void 0 !== n[""] && "" !== j && j === k ? n[""] : n[j], void 0 !== f)i = "" === m[f].unit.toString() && void 0 !== l ? new b(m[f].value, l).unify() : m[f].unify(), (a && h.value < i.value || !a && h.value > i.value) && (m[f] = g); else {
    ...
    }, {"../tree/anonymous": 42, "../tree/dimension": 52, "./function-registry": 21}], 25: [function (a) {
    ...
    }, {"../tree/anonymous": 42, "../tree/javascript": 59, "../tree/quoted": 69, "./function-registry": 21}], 26: [function (a, b) {
        b.exports = function (b) {
            var c = a("../tree/dimension"), d = a("../tree/color"), e = a("../tree/anonymous"), f = a("../tree/url"), g = a("./function-registry");
            g.add("svg-gradient", function (a) {
                ...
                var h, i, j, k, l, m, n, o = Array.prototype.slice.call(arguments, 1), p = "linear", q = 'x="0" y="0" width="1" height="1"', r = !0, s = {compress: !1}, t = a.toCSS(s);
                switch (t) {
                    case"to bottom":
    ...
    }, {"../tree/anonymous": 42, "../tree/color": 46, "../tree/dimension": 52, "../tree/url": 76, "./function-registry": 21}], 27: [function (a) {
        ...
        i.addMultiple({iscolor: function (a) {
            return j(a, d)
        }, isnumber: function (a) {
            return j(a, c)
        }, isstring: function (a) {
    ...
    }, {"../tree/anonymous": 42, "../tree/color": 46, "../tree/dimension": 52, "../tree/keyword": 61, "../tree/operation": 67, "../tree/quoted": 69, "../tree/url": 76, "./function-registry": 21}], 28: [function (a, b) {
        ...
        b.exports = function (a) {
            ...
            return b.prototype.push = function (b, e, f, g, h) {
                ...
                }, k = {relativeUrls: this.context.relativeUrls, entryPath: f.entryPath, rootpath: f.rootpath, rootFilename: f.rootFilename}, l = a.getFileManager(b, f.currentDirectory, this.context, a);
    ...
    }, {"./contexts": 10, "./parser/parser": 35}], 29: [function (a, b) {
        b.exports = function (b, c) {
            var d, e, f, g, h, i = {version: [2, 1, 0], data: a("./data"), tree: a("./tree"), Environment: h = a("./environment/environment"), AbstractFileManager: a("./environment/abstract-file-manager"), environment: b = new h(b, c), visitors: a("./visitors"), Parser: a("./parser/parser"), functions: a("./functions")(b), contexts: a("./contexts"), SourceMapOutput: d = a("./source-map-output")(b), SourceMapBuilder: e = a("./source-map-builder")(d), ParseTree: f = a("./parse-tree")(e), ImportManager: g = a("./import-manager")(b), render: a("./render")(b, f, g), LessError: a("./less-error"), transformTree: a("./transform-tree"), utils: a("./utils"), PluginManager: a("./plugin-manager"), logger: a("./logger")};
            return i
        }
    }, {"./contexts": 10, "./data": 12, "./environment/abstract-file-manager": 14, "./environment/environment": 15, "./functions": 22, "./import-manager": 28, "./less-error": 30, "./logger": 31, "./parse-tree": 32, "./parser/parser": 35, "./plugin-manager": 36, "./render": 37, "./source-map-builder": 38, "./source-map-output": 39, "./transform-tree": 40, "./tree": 58, "./utils": 79, "./visitors": 83}], 30: [function (a, b) {
        ...
        var c = a("./less-error"), d = a("./transform-tree");
        b.exports = function (a) {
            var b = function (a, b) {
            ...
            return b.prototype.toCSS = function (b) {
                ...
                try {
                    var i = {compress: Boolean(b.compress), dumpLineNumbers: b.dumpLineNumbers, strictUnits: Boolean(b.strictUnits), numPrecision: 8};
                    b.sourceMap ? (f = new a(b.sourceMap), g.css = f.toCSS(e, i, this.imports)) : g.css = e.toCSS(i)
                } catch (h) {
                    throw new c(h, this.imports)
                }
                if (b.pluginManager)for (var j = b.pluginManager.getPostProcessors(), k = 0; k < j.length; k++)g.css = j[k].process(g.css, {sourceMap: f, options: b, imports: this.imports});
    ...
    }, {"./less-error": 30, "./transform-tree": 40}], 33: [function (a, b) {
        b.exports = function (a, b) {
            function c(b) {
                var c = h - q;
                ...
                for (var c, e, f, j = k.i, p = d, q = k.i - i, s = k.i + h.length - q, u = k.i += a, v = b; k.i < s; k.i++) {
                    if (c = v.charCodeAt(k.i), k.autoCommentAbsorb && c === r) {
                        ...
                        if ("*" === e) {
                            ...
                            if (y) {
                                f = {index: k.i, text: y[0], isLineComment: !1}, k.i += f.text.length - 1, k.commentStore.push(f);
                                continue
                            }
                        }
                        break
        ...
        var c = a("../less-error"), d = a("../tree"), e = a("../visitors"), f = a("./parser-input"), g = a("../utils"), h = function i(a, b, h) {
            ...
            return{parse: function (f, g, j) {
                ...
                if (!r.isFinished) {
                    ...
                    s || (s = "Unrecognised input", "}" === r.furthestChar ? s += ". Possibly missing opening '{'" : ")" === r.furthestChar ? s += ". Possibly missing opening '('" : r.furthestReachedEnd && (s += ". Possibly missing something")), n = new c({type: "Parse", message: s, index: r.furthest, filename: h.filename}, b)
                }
                var t = function (a) {
                ...
                var b, c, e, f, g, h, i = n.entities, j = {args: null, variadic: !1}, k = [], m = [], p = [];
                for (o.save(); ;) {
                    ...
                    if (a ? h.value && 1 == h.value.length && (q = h.value[0]) : q = h, q && q instanceof d.Variable)if (o.$char(":")) {
                        ...
                        if (!a && o.$re(/^\.{3}/)) {
                            j.variadic = !0, o.$char(";") && !b && (b = !0), (b ? m : p).push({name: h.name, variadic: !0});
                            break
                        }
                        a || (e = f = q.name, g = null)
                    }
                    g && k.push(g), p.push({name: f, value: g}), o.$char(",") || (o.$char(";") || b) && (c && l("Cannot mix ; and , as delimiter types"), b = !0, k.length > 1 && (g = new d.Value(k)), m.push({name: e, value: g}), e = null, k = [], c = !1)
                }
    ...
    }, {"../less-error": 30, "../tree": 58, "../utils": 79, "../visitors": 83, "./parser-input": 34}], 36: [function (a, b) {
        var c = function (a) {
        ...
        b.exports = function (a, b, g) {
            var h = function (a, i, j) {
                ...
                if (m.addPlugins(i.plugins), i.pluginManager = m, k = new d.Parse(i), i.rootFileInfo)l = i.rootFileInfo; else {
                    var n = i.filename || "input", o = n.replace(/[^\/\\]*$/, "");
                    l = {filename: n, relativeUrls: k.relativeUrls, rootpath: k.rootpath || "", currentDirectory: o, entryPath: o, rootFilename: n}
                }
                var p = new g(k, l);
                new e(k, p, l).parse(a, function (a, c) {
                    if (a)return j(a);
                    try {
                        var d = new b(c, p), e = d.toCSS(i);
                        j(null, e)
                    } catch (f) {
                        j(f)
                    }
    ...
    }, {"./contexts": 10, "./parser/parser": 35, "./plugin-manager": 36, promise: void 0}], 38: [function (a, b) {
        b.exports = function (a) {
            var b = function (a) {
                this.options = a
            };
        ...
        b.exports = function (a) {
            ...
            return b.prototype.normalizeFilename = function (a) {
                ...
                if (this._sourceMapGenerator = new this._sourceMapGeneratorConstructor({file: this._outputFilename, sourceRoot: null}), this._outputSourceFiles)for (var c in this._contentsMap)if (this._contentsMap.hasOwnProperty(c)) {
    ...
    }, {"./contexts": 10, "./tree": 58, "./visitors": 83}], 41: [function (a, b) {
    ...
    }, {"../functions/function-caller": 20, "./node": 66}], 46: [function (a, b) {
        function c(a, b) {
    ...
    }, {"../data/colors": 11, "./node": 66}], 47: [function (a, b) {
        var c = a("./node"), d = function (a) {
    ...
    }, {"./debug-info": 50, "./node": 66}], 49: [function (a, b) {
        var c = a("./node"), d = function (a, b, c, d, e) {
    ...
    }, {"../contexts": 10, "./node": 66}], 52: [function (a, b) {
    ...
    }, {"../data/unit-conversions": 13, "./color": 46, "./node": 66, "./unit": 75}], 53: [function (a, b) {
    ...
    }, {"./node": 66, "./ruleset": 72}], 54: [function (a, b) {
    ...
    }, {"./combinator": 47, "./node": 66, "./paren": 68}], 55: [function (a, b) {
    ...
    }, {"./comment": 48, "./node": 66, "./paren": 68}], 56: [function (a, b) {
    ...
    }, {"./anonymous": 42, "./media": 62, "./node": 66, "./quoted": 69, "./ruleset": 72, "./url": 76}], 58: [function (a, b) {
        var c = {};
    ...
    }, {"./anonymous": 42, "./dimension": 52, "./js-eval-node": 60, "./quoted": 69}], 60: [function (a, b) {
    ...
    }, {"./node": 66, "./variable": 78}], 61: [function (a, b) {
        var c = a("./node"), d = function (a) {
            this.value = a
        };
    ...
    }, {"./anonymous": 42, "./directive": 53, "./element": 54, "./expression": 55, "./ruleset": 72, "./selector": 73, "./value": 77}], 63: [function (a, b) {
        ...
        g.prototype = new c, g.prototype.type = "MixinCall", g.prototype.accept = function (a) {
            ...
            for (h = this.arguments && this.arguments.map(function (b) {
            ...
            }, i = 0; i < a.frames.length; i++)if ((c = a.frames[i].find(this.selector, null, s)).length > 0) {
                for (m = !0, j = 0; j < c.length; j++) {
                    for (d = c[j].rule, g = c[j].path, l = !1, k = 0; k < a.frames.length; k++)if (!(d instanceof e) && d === (a.frames[k].originalRuleset || a.frames[k])) {
                        l = !0;
                        break
                    }
                ...
                if (q[y] > 0)p = A; else if (p = z, q[z] + q[A] > 1)throw{type: "Runtime", message: "Ambiguous use of `default()` found when matching for `" + this.format(h) + "`", index: this.index, filename: this.currentFileInfo.filename};
                for (j = 0; j < v.length; j++)if (o = v[j].group, o === y || o === p)try {
                    ...
                    throw{message: B.message, index: this.index, filename: this.currentFileInfo.filename, stack: B.stack}
                }
                if (u) {
                    if (!this.currentFileInfo || !this.currentFileInfo.reference)for (i = 0; i < t.length; i++)n = t[i], n.markReferenced && n.markReferenced();
                    return t
                }
            }
            throw m ? {type: "Runtime", message: "No matching definition was found for `" + this.format(h) + "`", index: this.index, filename: this.currentFileInfo.filename} : {type: "Name", message: this.selector.toCSS().trim() + " is undefined", index: this.index, filename: this.currentFileInfo.filename}
    ...
    }, {"../functions/default": 19, "./mixin-definition": 64, "./node": 66, "./selector": 73}], 64: [function (a, b) {
    ...
    }, {"../contexts": 10, "./element": 54, "./expression": 55, "./rule": 70, "./ruleset": 72, "./selector": 73}], 65: [function (a, b) {
    ...
    }, {"./dimension": 52, "./node": 66, "./operation": 67}], 66: [function (a, b) {
        var c = function () {
        };
        c.prototype.toCSS = function (a) {
            ...
            for (var d = 0; d < a.length; d++)if (0 !== c.compare(a[d], b[d]))return void 0;
            return 0
    ...
    }, {"./color": 46, "./dimension": 52, "./node": 66}], 68: [function (a, b) {
        var c = a("./node"), d = function (a) {
            this.value = a
        };
    ...
    }, {"./js-eval-node": 60, "./node": 66, "./variable": 78}], 70: [function (a, b) {
        function c(a, b) {
    ...
    }, {"./keyword": 61, "./node": 66, "./value": 77}], 71: [function (a, b) {
    ...
    }, {"./node": 66, "./variable": 78}], 72: [function (a, b) {
        ...
        j.prototype = new c, j.prototype.type = "Ruleset", j.prototype.isRuleset = !0, j.prototype.isRulesetLike = !0, j.prototype.accept = function (a) {
            ...
            if (g && (c = g.length)) {
                for (b = [], h.error({type: "Syntax", message: "it is currently only allowed in parametric mixin guards,"}), f = 0; c > f; f++)e = g[f].eval(a), b.push(e), e.evaldCondition && (i = !0);
                h.reset()
            } else i = !0;
            ...
            for (f = 0; f < q.length; f++)if (k = q[f], k instanceof j && k.selectors && 1 === k.selectors.length && k.selectors[0].isJustParentSelector()) {
                q.splice(f--, 1);
                for (var t = 0; t < k.rules.length; t++)l = k.rules[t], l instanceof d && l.variable || q.splice(++f, 0, l)
            }
            if (o.shift(), p.shift(), a.mediaBlocks)for (f = s; f < a.mediaBlocks.length; f++)a.mediaBlocks[f].bubbleSelectors(b);
            return n
        }, j.prototype.evalImports = function (a) {
            var b, c, d = this.rules;
            if (d)for (b = 0; b < d.length; b++)"Import" === d[b].type && (c = d[b].eval(a), c && c.length ? (d.splice.apply(d, [b, 1].concat(c)), b += c.length - 1) : d.splice(b, 1, c), this.resetCache())
            ...
            if (h) {
                for (r = [], i = [
                    []
                ], d = 0; d < c.elements.length; d++)if (j = c.elements[d], "&" !== j.value)r.push(j); else {
                    for (s = [], r.length > 0 && this.mergeElementsOnToSelectors(r, i), e = 0; e < i.length; e++)if (k = i[e], 0 === b.length)k.length > 0 && (k[0].elements = k[0].elements.slice(0), k[0].elements.push(new f(j.combinator, "", j.index, j.currentFileInfo))), s.push(k); else for (g = 0; g < b.length; g++) {
            ...
            } else if (b.length > 0)for (d = 0; d < b.length; d++)a.push(b[d].concat(c)); else a.push([c])
    ...
    }, {"../contexts": 10, "../functions/default": 19, "./debug-info": 50, "./element": 54, "./node": 66, "./rule": 70, "./selector": 73}], 73: [function (a, b) {
    ...
    }, {"../data/unit-conversions": 13, "./node": 66}], 76: [function (a, b) {
        ...
        f.prototype = {run: function (a) {
            ...
            for (d = d || 0, e = 0; e < a.length; e++)for (f = 0; f < b.length; f++)j = a[e], k = b[f], j.parent_ids.indexOf(k.object_id) >= 0 || (i = [k.selfSelectors[0]], g = n.findMatch(j, i), g.length && j.selfSelectors.forEach(function (a) {
    ...
    }, {"../tree": 58, "./visitor": 86}], 81: [function (a, b) {
        function c(a) {
        ...
        f.prototype = {isReplacing: !1, run: function (a) {
            ...
            if (!d || d.css && !e)this.importCount--; else {
    ...
    }, {"../contexts": 10, "./import-sequencer": 81, "./visitor": 86}], 83: [function (a, b) {
        ...
        b.exports = c
    }, {"./extend-visitor": 80, "./import-visitor": 82, "./join-selector-visitor": 84, "./to-css-visitor": 85, "./visitor": 86}], 84: [function (a, b) {
        ...
        e.prototype = {isReplacing: !0, run: function (a) {
            ...
            for (var b, d = 0; d < a.length; d++)if (b = a[d], b instanceof c.Rule && !b.variable)throw{message: "properties must be inside selector blocks, they cannot be in the root.", index: b.index, filename: b.currentFileInfo ? b.currentFileInfo.filename : null}
            ...
            if (a.firstRoot && this.checkPropertiesInRoot(a.rules), a.root)a.accept(this._visitor), b.visitDeeper = !1, (a.firstRoot || a.rules && a.rules.length > 0) && e.splice(0, 0, a); else {
                a.paths && (a.paths = a.paths.filter(function (a) {
                    var b;
                    for (" " === a[0].elements[0].combinator.value && (a[0].elements[0].combinator = new c.Combinator("")), b = 0; b < a.length; b++)if (a[b].getIsReferenced() && a[b].getIsOutput())return!0;
                    return!1
                }));
    ...
    }, {"../tree": 58, "./visitor": 86}], 86: [function (a, b) {
        function c(a) {
            return a
        }
    ...
    }, {"./core.js": 88, asap: 90}], 90: [function (a, b) {
        (function (a) {
            function c() {
                for (; e.next;) {
                    e = e.next;
